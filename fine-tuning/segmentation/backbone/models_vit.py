...
from mmcv_custom.pos_embed import interpolate_pos_embed
...
class ViT(timm.models.vision_transformer.VisionTransformer):
    ...
    """
    def __init__(self, embed_dim=768,out_indices = [3, 5, 7, 11], norm_layer=partial(nn.LayerNorm, eps=1e-6),mim_model='', **kwargs):
        super(ViT, self).__init__(embed_dim=768, norm_layer = norm_layer, **kwargs)
