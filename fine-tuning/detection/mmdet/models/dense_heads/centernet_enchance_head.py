...
class CenterNetEnhanceHead(BaseDenseHead, BBoxTestMixin):
    ...
    def __init__(self,
                 ...
                 loss_distribution = dict(type='DistributionL1Loss',loss_weight=0.1),
                 train_cfg=None,
                 test_cfg=None,
                 init_cfg=None):
        super(CenterNetEnhanceHead, self).__init__(init_cfg)
        ...
        self.loss_distribution  = build_loss(loss_distribution)
    ...
    def loss(self,
        ...
        loss_distribution = self.loss_distribution(
            [center_heatmap_pred,wh_pred,offset_pred],
            [center_heatmap_target,wh_target,offset_pred]
        )
        return dict(
